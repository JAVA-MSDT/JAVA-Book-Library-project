...
public class EnumService {
	 ...
	 */
	public static String getString(@SuppressWarnings("rawtypes") final Enum[] values, final String string) {
	 ...
	 */
	public static ReadingPlace getReadingPlace(final String readingPlace) {
