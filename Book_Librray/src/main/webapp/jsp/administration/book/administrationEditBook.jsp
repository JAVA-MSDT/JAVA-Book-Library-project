		...
		<div class="basicInfo">
					...
					<c:choose>
						<c:when test="${validation eq 'nameError'}">
							<h3 style="color: firebrick">
								<fmt:message key="validation.book.title" />
							</h3>
						</c:when>
						<c:when test="${validation eq 'quantityError'}">
							<h3 style="color: firebrick">
								<fmt:message key="validation.book.quantity" />
							</h3>
						</c:when>
					</c:choose>
				</c:forEach>
			...
			<div class="container">
				<div class="editContainerForm">
					<form id="librarianBookForm" name="administration-update-book"
						...
						<div class="row">
							...
							<div class="inputCol">
								<input type="number" name="quantity" id="quantity"
									...
									pattern="^[1-9]\d*$"
									placeholder="<fmt:message key="validation.book.quantity"/>"
									required>
							</div>
						</div>
						<div class="row">
							<input type="submit" onclick="return bookFormValidation()"
