...
<html>
<head>
<title><c:if test="${ not empty sessionScope.user}">
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/bookCard.css">
<script rel="script"
	src="${pageContext.request.contextPath}/js/displayBookOption.js"></script>
</head>
<body>
		...
		<div class="basicInfo">
						...
						<div class="row-option">
							<div class="option-col">
								<select id="display-option" class="select-option" name="type"
									onchange="displayBook()">
									<option value="displayCard"><fmt:message
											key="label.display.card" /></option>
									<option value="displayTable"><fmt:message
											key="label.display.table" /></option>
								</select>
							</div>
						</div>
					</form>
			...
			<c:choose>
				<c:when test="${param.operationStatus eq 'confirmed'}">
					<h2 class="permission" style="color: green">
						<fmt:message key="message.book.order.done" />
					</h2>
					<br>
				</c:when>
			</c:choose>
							...
							<c:forEach var="bookList" items="${requestScope.bookList}"
								...
								<div class="book-card">
									<div class="card-container">
										<img src="../../img/effective.jpg" alt="Avatar"
											class="book-image">
										<div class="name-overlay">
											<div class="book-info">
												...
												<div class="book-row">
													...
													<c:if
														test="${sessionScope.user.role eq 'LIBRARIAN' or sessionScope.user.role eq 'ADMIN'}">
										...
										<div class="view-book">
											<form name="view-book" action="controller" method="post">
												...
												<input class="book-btn" type="submit" name="view"
													value="<fmt:message key="button.view"/> " /> <input
													type="hidden" name="id"
											...
											<div class="edit-book">
												<form name="administration-edit-book" action="controller"
													...
													<input type="hidden" name="command"
														...
														class="book-btn" type="submit" name="view"
