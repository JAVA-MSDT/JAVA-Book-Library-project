...
<c:choose>
	...
	<c:when test="${sessionScope.user == null}">
		<footer class="footer">
			<div class="footLinks">
				<div class="footMenu">
					<ul>
						<li><a href="../../index.jsp"><fmt:message key="nav.home" />
						</a></li>
						<li><a href="../../login.jsp"><fmt:message
				...
				<div class="socialMedia">
					<ul>
						<li><a href="https://www.facebook.com/EPAM.Belarus/"
							target="_blank">Facebook</a></li>
						<li><a href="https://twitter.com/epam_minsk" target="_blank">Twitter</a></li>
						<li><a href="https://www.linkedin.com/company/epam-systems/"
			...
			<div class="copyright">
				...
				<p>
					<fmt:message key="message.dev.des.by" />
					<a href="https://github.com/JAVA-MSDT">Ahmed Samy</a>
				</p>
			</div>
		</footer>
	</c:when>
	...
	<c:otherwise>
		<footer class="profileFooter">
			<p>
				<fmt:message key="message.for.help" />
				<a href="#"><fmt:message key="label.contact.us" /> </a>
			</p>
			<p>
			<p>&#64; Copyright: Epam System Belarus 2019</p>
			<p>
