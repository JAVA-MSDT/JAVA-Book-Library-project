...
<body>
	...
	<div class="loginContainer">
		<div class="form" style="width: 50%">
			...
			<img src="${pageContext.request.contextPath}img/epam.jpg" width="300"
				height="100">
				...
				<div class="row">
					...
					<div class="inputCol">
						<input type="text" name="name" id="user-name"
							pattern="([\w\s]{0,30})$"
							placeholder="<fmt:message key="validation.user.name"/>" required>
					</div>
				</div>
				<div class="row">
					<div class="labelCol">
				...
				<div class="row">
					...
					<div class="inputCol">
						<input type="text" name="login" id="user-login"
							pattern="^([a-zA-Z]{2,10})$"
							placeholder="<fmt:message key="validation.user.login"/>" required>
					</div>
				</div>
				<div class="row">
					<div class="labelCol">
