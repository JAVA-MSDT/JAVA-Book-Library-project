...
<fmt:setBundle basename="locale"/>
    ...
    <nav class="top-nav">
        ...
        <ul id="nav-list">
            <li><a href="controller?command=reader-profile"><fmt:message key="nav.profile"/></a></li>
            <li><a href="controller?command=display-book"><fmt:message key="label.book.store"/></a></li>
            <li><a href="controller?command=reader-order"><fmt:message key="label.order.list"/></a></li>
